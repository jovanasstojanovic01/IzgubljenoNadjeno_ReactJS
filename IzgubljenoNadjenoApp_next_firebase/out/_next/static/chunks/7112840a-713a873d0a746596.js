 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l2{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=oY(e)}set(e,t,n){this._verifyNotCommitted();let r=l4(e,this._firestore),i=lF(r.converter,t,n),s=oX(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,nx.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=l4(e,this._firestore);return i="string"==typeof(t=(0,l.m9)(t))||t instanceof oB?o3(this._dataReader,"WriteBatch.update",s._key,t,n,r):o5(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,nx.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=l4(e,this._firestore);return this._mutations=this._mutations.concat(new nL(t._key,nx.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new S(T.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function l4(e,t){if((e=(0,l.m9)(e)).firestore!==t)throw new S(T.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l5 extends class{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=oY(e)}get(e){let t=l4(e,this._firestore),n=new lV(this._firestore);return this._transaction.lookup([t._key]).then(e=>{if(!e||1!==e.length)return b();let r=e[0];if(r.isFoundDocument())return new la(this._firestore,n,r.key,r,t.converter);if(r.isNoDocument())return new la(this._firestore,n,t._key,null,t.converter);throw b()})}set(e,t,n){let r=l4(e,this._firestore),i=lF(r.converter,t,n),s=oX(this._dataReader,"Transaction.set",r._key,i,null!==r.converter,n);return this._transaction.set(r._key,s),this}update(e,t,n,...r){let i;let s=l4(e,this._firestore);return i="string"==typeof(t=(0,l.m9)(t))||t instanceof oB?o3(this._dataReader,"Transaction.update",s._key,t,n,r):o5(this._dataReader,"Transaction.update",s._key,t),this._transaction.update(s._key,i),this}delete(e){let t=l4(e,this._firestore);return this._transaction.delete(t._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){let t=l4(e,this._firestore),n=new lB(this._firestore);return super.get(e).then(e=>new lL(this._firestore,n,t._key,e._document,new lM(!1,!1),t.converter))}}function l3(e,t,n){e=ou(e,o_);let r=Object.assign(Object.assign({},l1),n);return!function(e){if(e.maxAttempts<1)throw new S(T.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(e,t,n){let r=new x;return e.asyncQueue.enqueueAndForget(async()=>{let i=await a5(e).then(e=>e.datastore);new aJ(e.asyncQueue,i,n,t,r).run()}),r.promise}(oN(e),n=>t(new l5(e,n)),r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l8(){return new oJ("deleteField")}function l9(){return new o0("serverTimestamp")}function l6(...e){return new o1("arrayUnion",e)}function l7(...e){return new o2("arrayRemove",e)}function ue(e){return new o4("increment",e)}!function(e,t=!0){f=s.SDK_VERSION,(0,s._registerComponent)(new a.wA("firestore",(e,{instanceIdentifier:n,options:r})=>{let i=e.getProvider("app").getImmediate(),s=new o_(new C(e.getProvider("auth-internal")),new F(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(T.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new e7(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,s.registerVersion)(h,"3.12.1",void 0),(0,s.registerVersion)(h,"3.12.1","esm2017")}()}}]);